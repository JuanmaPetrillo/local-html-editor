...
cpSync('apps/desktop/src/zip-manifest-model.mjs', 'dist/src/zip-manifest-model.mjs');
...
const distZipManifestModel = readFileSync('dist/src/zip-manifest-model.mjs', 'utf8');
...
if (!distShell.includes("from './exporter.mjs'") || !distShell.includes("from './visual-object-model.mjs'") || !distShell.includes("from './visual-layout-model.mjs'")) {
...
if (distZipManifestModel.length === 0) {
  throw new Error('dist/src/zip-manifest-model.mjs is empty');
}

console.log(
  'build completed: dist/index.html, dist/src/app-shell.mjs, dist/src/importer.mjs, dist/src/preview-sandbox.mjs, dist/src/editable-model.mjs, dist/src/exporter.mjs, dist/src/visual-object-model.mjs, dist/src/visual-layout-model.mjs, dist/src/zip-manifest-model.mjs'
);
