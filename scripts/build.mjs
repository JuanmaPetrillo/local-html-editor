...
if (!distShell.includes("from './exporter.mjs'")) {
...
console.log(
  'build completed: dist/index.html, dist/src/app-shell.mjs, dist/src/importer.mjs, dist/src/preview-sandbox.mjs, dist/src/editable-model.mjs, dist/src/exporter.mjs'
);
