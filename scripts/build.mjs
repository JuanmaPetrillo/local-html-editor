...
if (!distImporter.includes("from './preview-sandbox.mjs'")) {
...
console.log(
  'build completed: dist/index.html, dist/src/app-shell.mjs, dist/src/importer.mjs, dist/src/preview-sandbox.mjs'
);
